...
function renderLastRegistered() {
  ...
  var email =localStorage.getItem("Previous Email");
  userEmailSpan.textContent = email;


  var password = localStorage.getItem("previous Pssword");
...
signUpButton.addEventListener("click", function (event) {
  ...
  if (email === "") {
    ...
    // localStorage.setItem(item name as string, variable name);

   localStorage.setItem("Previous Email", email );
   localStorage.setItem("previous Pssword", password);
